...
public class AreaFragment extends Fragment {
    ...
    private Button calcSquare, calcTriangle, calcCircle;
    private TextView resSquare, resTriangle, resCircle;
    Double num1, num2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        calcCircle.setOnClickListener(view1 -> {
